    ...
    async with request.app['engine'].acquire() as conn:
        ...
        for row in searches_per_month_records:
            ...
            if period == "2021-07":
                ...
                searches_per_month_result.append({period: row_as_dict['count'] + 1807})
            else:
        ...
        rnacentral_searches = [
            ...
            {"2021-03": 2482}, {"2021-04": 942}, {"2021-05": 1173}, {"2021-06": 869}
        ]
        rfam_searches = [
            ...
            {"2021-03": 1538}, {"2021-04": 1102}, {"2021-05": 1278}, {"2021-06": 1149}
        ]
        mirbase_searches = [
